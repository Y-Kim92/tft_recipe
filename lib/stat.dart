...
class StatRecipe extends StatefulWidget {
  const StatRecipe({Key? key}) : super(key: key);

  @override
  State<StatRecipe> createState() => _StatRecipeState();
}
class MyColors {
...
class _StatRecipeState extends State<StatRecipe> {
  @override
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Image(
                          image: ExactAssetImage("assets/items/Statikk Shiv.png", scale: 3.00)
                      ),
                    ),
                  ),
                  Expanded(
                    ...
                    child: RichText(
                        text: TextSpan(
                            ...
                            children:const <TextSpan>[
                              TextSpan(
                                  text: '\n\nAP dmg and MR shred to 4 enemies every 3rd ATK',
