...
class FrozRecipe extends StatefulWidget {
  const FrozRecipe({Key? key}) : super(key: key);

  @override
  State<FrozRecipe> createState() => _FrozRecipeState();
}
class MyColors {
...
class _FrozRecipeState extends State<FrozRecipe> {
  @override
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Image(
                          image: ExactAssetImage("assets/items/Frozen Heart.png", scale: 3.00)
                      ),
                    ),
                  ),
                  Expanded(
                    ...
                    child: RichText(
                        text: TextSpan(
                            ...
                            children:const <TextSpan>[
                              TextSpan(
                                  text: '\n\n-30% AS in 2 Hexes Adjacent Enemies',
