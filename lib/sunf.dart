...
class SunfRecipe extends StatefulWidget {
  const SunfRecipe({Key? key}) : super(key: key);

  @override
  State<SunfRecipe> createState() => _SunfRecipeState();
}
class MyColors {
...
class _SunfRecipeState extends State<SunfRecipe> {
  @override
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Image(
                          image: ExactAssetImage("assets/items/Sunfire Cape.png", scale: 3.00)
                      ),
                    ),
                  ),
                  Expanded(
                    ...
                    child: RichText(
                        text: TextSpan(
                            ...
                            children:const <TextSpan>[
                              TextSpan(
                                  text: '\n\nBurn an enemy within 2 hexes dealt dmg reduce healing',
