...
class BlueRecipe extends StatefulWidget {
  const BlueRecipe({Key? key}) : super(key: key);

  @override
  State<BlueRecipe> createState() => _BlueRecipeState();
}
class MyColors {
...
class _BlueRecipeState extends State<BlueRecipe> {
  @override
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Image(
                          image: ExactAssetImage("assets/items/Blue Buff.png", scale: 3.00)
                      ),
                    ),
                  ),
                  Expanded(
                    ...
                    child: RichText(
                        text: TextSpan(
                            ...
                            children:const <TextSpan>[
                              TextSpan(
                                  text: '\n\nAfter casting a ability wearer\'s mana is set to 20',
                ...
                child: GridView.count(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Image(
                          image: ExactAssetImage("assets/champions/Irelia.png", scale: 3)
                      ),
                    ),
                    Container(
                      decoration: BoxDecoration(
