...
class QuicRecipe extends StatefulWidget {
  const QuicRecipe({Key? key}) : super(key: key);

  @override
  State<QuicRecipe> createState() => _QuicRecipeState();
}
class MyColors {
...
class _QuicRecipeState extends State<QuicRecipe> {
  @override
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Image(
                          image: ExactAssetImage("assets/items/Quicksilver.png", scale: 3.00)
                      ),
                    ),
                  ),
                  Expanded(
