...
class RabaRecipe extends StatefulWidget {
  const RabaRecipe({Key? key}) : super(key: key);

  @override
  State<RabaRecipe> createState() => _RabaRecipeState();
}
class MyColors {
...
class _RabaRecipeState extends State<RabaRecipe> {
  @override
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Image(
                          image: ExactAssetImage("assets/items/Rabadon's Deathcap.png", scale: 3.00)
                      ),
                    ),
                  ),
                  Expanded(
